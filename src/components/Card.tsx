...
export default function Card({ id, name, year }: WorkListProp) {
  return (
    <>
      <article className="group relative flex cursor-pointer flex-col items-center space-y-5 rounded-xl border-8 border-darkGreen/40 px-3 py-5 transition duration-300 hover:bg-darkGreen hover:text-white dark:border-white/20">
